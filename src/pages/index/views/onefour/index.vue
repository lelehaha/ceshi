      ...
      <el-form ref="form" :model="formData" label-width="80px">
        ...
        <el-form-item label="模型输入">
          <el-table :data="tableData" style="width: 100%" height="250">
            ...
            <el-table-column prop="state" label="源状态" width="100px">
            </el-table-column>
            <el-table-column prop="target" label="源目标" width="100px">
            </el-table-column>
            <el-table-column prop="describe" label="迁移上变量描述">
            </el-table-column>
          </el-table>
        </el-form-item>
      </el-form>
      <div style="width: 100%;margin-left: 120px;">
        <el-button>从文件载入EFSM模型</el-button>
        <el-button>添加迁移</el-button>
        <el-button>删除选中迁移</el-button>
      </div>
    ...
    return {
      ...
      tableData: [
        ...
        },
        {
          ...
          state: "0",
          target: "1",
          describe: "[['cb', 0, 0],['sb', 0, 1]...",
        },
        {
          index: "2",
          state: "1",
          target: "1",
          describe: "[['p',0,0],['attmpts',1...",
        },
        {
          index: "3",
          state: "2",
